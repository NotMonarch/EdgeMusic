...
async def start_pm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        await message.reply_photo(
            ...
            caption=("""
Hi {0}
<b>I am Edge Music BoT</b>
powered by @EdgeBots

I am a Powerful music streaming bot Deployed on a high-speed server.
Add me for a seamless music experience in Voice Chats

Check Help to get information about my modules ⚡
